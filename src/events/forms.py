...
class EventCreationForm(forms.ModelForm):
    ...
    start_time = forms.TimeField (widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'whatever', "label": ('Start Time'), "type":"time"}))
    ...
    end_time = forms.TimeField (widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'end Time', "label": ('End rime'), "type":"time"}))
    ...
    registration_link = forms.URLField (widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Expected duration time', "label": ('duration'), "type":"text"}))
    meeting_link = forms.URLField (widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Expected duration time', "label": ('duration'), "type":"text"}))
    ...
    class Meta:
        model = Event
        fields = (
            "title", "event_date", "start_time", "end_time","registration_link","meeting_link", "duration", "location", "country", "state", "description",)
